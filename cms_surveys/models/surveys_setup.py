...
class Surveys(models.Model):
    ...
    career_id = fields.Many2one('odoocms.career', related='batch_id.career_id', store=True, string='Career')
...
class SurveyUserInputInherit(models.Model):
    ...
    career_id = fields.Many2one('odoocms.career', related='survey_id.career_id', string='Career', store=True)
    institute_id = fields.Many2one('odoocms.institute', related='survey_id.institute_id', string='Institute', store=True)
...
class SurveyAssestmentTypes(models.Model):
    ...
    # template_id = fields.Many2one('odoocms.career', related='survey_id.career_id', string='Career', store=True)
