...
class SurveysTemplate(models.TransientModel):
    ...
    campus_id = fields.Many2one(comodel_name='odoocms.campus', string='Campus',
                                required=False, )
    institute_id = fields.Many2one(comodel_name='odoocms.institute', string='Institute', required=False, )

    career_id = fields.Many2one(comodel_name='odoocms.career', string='Career', required=False, )
