...
class OdooCMSClass(models.Model):
    ...
    career_id = fields.Many2one('odoocms.career', 'Career', related='primary_class_id.career_id', store=True)
...
class OdooCMSBatchTerm(models.Model):
    ...
    career_id = fields.Many2one('odoocms.career', string="Career", related='batch_id.career_id')
