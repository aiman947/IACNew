...
class OdooCMSAdmissionRegister(models.Model):
    ...
    career_id = fields.Many2one('odoocms.career', 'Career', required=False)
    ...
    matric_o_level_score = fields.Float('Matric / O-Level', default=50.0, tracking=True, required=True)
    intermediate = fields.Float('Intermediate', default=50.0, trackingtracking=True, required=True)
    under_graduate = fields.Float('Under Graduate', default=50.0, trackingtracking=True)
