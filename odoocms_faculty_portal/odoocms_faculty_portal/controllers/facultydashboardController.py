...
class FacultyDashboard(http.Controller):
    ...
    def f_dashboard(self, **kw):
        try:
            ...
            lectures = http.request.env['odoocms.class'].sudo().search([('faculty_staff_id', '=', faculty_staff.id),('term_id','=',values['config_term']),('component', 'in', ['lecture'])])
            labs = http.request.env['odoocms.class'].sudo().search([('faculty_staff_id', '=', faculty_staff.id), ('term_id', '=', values['config_term']), ('component', 'in', ['lab'])])
            ...
            return http.request.render('odoocms_faculty_portal.faculty_dashboard', values)
