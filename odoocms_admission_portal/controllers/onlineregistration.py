...
class AdmissionApplication(http.Controller):
    ...
    def save_admission_application_contents(self, application_id=False, access_token=None, report_type=None,
        ...
        try:
            ...
            print(666666666666666666666, kw)
            ...
            print(11111111111111111, personal_data)
            data = dict(bdata)
            print(222222222222222222222222222, data)
            ...
            print(1111111111111222222222222222, data)
